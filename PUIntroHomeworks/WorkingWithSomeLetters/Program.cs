...
namespace WorkingWithSomeLetters
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Даден е низ от 100 случайни букви на кирилица. Програмата показва кои гласни са широки, " +
                "тесни и съставни, както и кои съгласни са звучни, беззвучни и сонорни.");
            Console.WriteLine("-------------------------------------------------------");
            for (int i = 0; i < 100; i++)
            {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                if ((stringArray[i] == "п") || (stringArray[i] == "ф") || (stringArray[i] == "к") || (stringArray[i] == "т")
                    || (stringArray[i] == "ш") || (stringArray[i] == "с") || (stringArray[i] == "x") || (stringArray[i] == "ц"))
                {
                ...
                if ((stringArray[i] == "б") || (stringArray[i] == "в") || (stringArray[i] == "г") || (stringArray[i] == "д") 
                    || (stringArray[i] == "ж") || (stringArray[i] == "з") || (stringArray[i] == "ч"))
                {
